...
protected:
    ...
    static LRESULT OnNMCustomdraw(NMHDR* pnmh);
    ...
    static void addColumnsToDisassembler(CListViewCtrl& list);
...
private:
    ...
    void addModuleAddressCommentEntry(DWORD_PTR address, DWORD moduleSize, LPCTSTR modulePath);
    void analyzeAddress(DWORD_PTR address, LPTSTR comment);
};
