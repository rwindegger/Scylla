...
protected:
    ...
    static const TCHAR filterExe[];
    static const TCHAR filterDll[];
    static const TCHAR filterExeDll[];
    static const TCHAR filterTxt[];
    static const TCHAR filterXml[];
    static const TCHAR filterMem[];
...
protected:
    ...
    void SetupImportsMenuItems(const CTreeItem& item);
    ...
    bool getCurrentModulePath(LPTSTR buffer, size_t bufferSize) const;
    ...
    bool getCurrentDefaultDumpFilename(LPTSTR buffer, size_t bufferSize) const;
};
